...
<div class="container">
    ...
    <div class="divPanel page-content">
		...
		<form role="form" name="login" action="club.php" method="get">
		  <div class="form-group">
		    <label for="email">Email</label>
		    <input type="text" class="form-control" id="email" name="email" placeholder="Escriba su nombre de usuario...">
		  </div>
		  <div class="form-group">
		...
		<form role="form" name="registro" action="reciboFormulario.php" method="get">
                    <div class="form-group">
