<!--Pagina que inserta productos en la base de datos-->
...
//movemos la imagen a la ruta anterior. Si existe un fallo avisamos.
...
//insertamos los datos en la base de datos
    $sql = "INSERT INTO producto (codigo,nombre,precio, stock, descuento, categoria, marca, imagen) "
            . "VALUES ('$codigo','$nombre','$precio','$stock','$descuento','$categoria','$marca', '$imagen')";
            ...
            <body id="pageBody">
                ...
                <div class="container">
                    ...
                    <div class="divPanel page-content">
                        ...
                        <!--Avisamos de que se ha cargado y redirigimos-->
                        <div class="row-fluid">
