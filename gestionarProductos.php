<!--Página que permite gestionar los productos. 
Tiene un formulario para añadir productos, otro para editar y otro para eliminar-->
<?php
...
// Check connection
            ...
            <div class="container">
                ...
                <div class="divPanel page-content">
                    ...
                    <div class="row-fluid">
                        ...
                        <!--Formulario para insertar productos. Comprueba que los datos son validos y nos manda a insertar.php para insertarlos en la base de datos-->               
                        <div class="divPanel page-content">
                            ...
                            <form role="form" name="acceso" action="insertar.php" method="post" enctype="multipart/form-data">
                                ...
                                <input type="number" class="form-control" id="username" name="precio" required>
                                <label for="stock">Stock</label>
                                <input type="number" class="form-control" id="password" name="stock" required>
                                <label for="descuento">Descuento</label>
                                <input type="number" class="form-control" id="username" name="descuento" required>
                                <!--Realizamos un select contra la base de datos para mostrar todas las categorías existentes-->
                                <p>
                                    Categoria
                                <p>
    <?php
    ...
    ?>
                            ...
                            <!--Formulario para actualizar un produscto. Realiza un select para mostrarnos en un desplegable los productos que hay. Seleccionamos el que queremos y editamos sobre ese-->
    ...
    ?>
                            ...
                            <!--Formulario para eliminar producto. Nos muestra el listado de los productos en un desplegable y eleccionamos el que queremos eliminar-->
