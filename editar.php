<!--Pagina que edita los productos en la base de datos-->
<?php
...
//realizamos un update con los datos anteriores para actualizar los productos.
            ...
            <body id="pageBody">
                ...
                <div class="container">
                    ...
                    <div class="divPanel page-content">
                        ...
                        <!--Mostramos que los datos han sido editados y redirigimos-->
                        <div class="row-fluid">
                            <h1>Datos editados correctamente</h1>
 ...
 <!--Aviso que se muestra si existe algún error-->
                        <div class="row-fluid">
                            <h1>No se han podido editar los datos. Existe un error.</h1>
